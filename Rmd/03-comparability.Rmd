...
```{r mappingfm, echo=FALSE, warning=FALSE, results='hide'}
...
```{r mappinggm, echo=FALSE, warning=FALSE, results='hide'}
...
```{r mappingcog, echo=FALSE,  warning=FALSE, results='hide'}
...
```{r mappingexp, echo=FALSE, warning=FALSE, results='hide'}
...
```{r mappingrec, echo=FALSE,  warning=FALSE, results='hide'}
...
```{r mappingshiny, echo=FALSE, fig.cap='(ref:mappingshiny)', fig.width=12, fig.keep = 'all', fig.align="center"}
library(ggplot2)
library(gtools)
library(shiny)
