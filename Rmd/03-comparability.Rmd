...
```{r linkage, eval=FALSE, include=FALSE}
...
<!-- NOTE: cannot get the refernced figure names to be linked, I don't know what I'm doing wrong.. -->
...
```{r poteq, echo=FALSE, fig.height=12, fig.keep='all', warning=FALSE, results='hide', fig.cap = '(ref:poteq)'}
...
```{r badeq, echo=FALSE,  fig.height=12, fig.keep='all', warning=FALSE, results='hide', fig.cap = '(ref:badeq)'}
