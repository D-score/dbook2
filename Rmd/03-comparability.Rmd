...
connections. In Table \@ref(ref:linkage) the connections between the cohorts via
...
knitr::include_app("https://tnochildhealthstatistics.shinyapps.io/GCDG_instrument_linkage/", 
  height = "600px")
```
(ref:linkage) Overview of linkage between the cohorts via overlapping instruments.
