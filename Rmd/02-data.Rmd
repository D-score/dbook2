...
ggsave("fig/fig_2.1.tiff", device = "tiff", width = 8, height = 4, dpi = 300)
```
...
```{r design, fit.width = 10, fig.keep='all', results='hide', fig.cap = '(ref:design)', warning=FALSE}
#orginally fig.width =10
...
tiff("fig/fig_2.2.tiff", unit = "in", width = 10, height = 5, res = 300)
