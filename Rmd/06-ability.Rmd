...
```{r dscoredist, echo=FALSE, fig.width=10, fig.cap = '(ref:dscoredist)'}
...
from the Chili 2 (GCDG-CHL-2) cohort. The grey line displays the overall
$D$-score (38.55$D$) and the colored points are the domain $D$-scores. This
plot shows that for the language domains (i.e. Expressive and Receptive), this
