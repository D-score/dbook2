...
```{r semfora, results = 'hide', fig.keep = 'all', warning = FALSE, fig.cap = '(ref:semfora)', message = FALSE, echo = FALSE}
library("dmetric")
library("gseddata")
library("dplyr")
