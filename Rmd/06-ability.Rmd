...
```{r dscoresems, echo=FALSE, fig.width=10, fig.cap = '(ref:dscoresems)'}
...
```{r domaincov, results = 'hide', fig.keep = 'all', warning = FALSE, fig.cap = '(ref:domaincov)', message = FALSE, echo = FALSE, fig.width=11}
library(tidyr)
library(dplyr)
...
```{r domaind, echo=FALSE, fig.cap='(ref:domaind)', fig.keep='all', message=FALSE, warning=FALSE, cache=TRUE, results='hide', fig.width=11}
...
```{r domaindex, echo=FALSE, fig.cap='(ref:domaindex)', fig.keep='all', message=FALSE, warning=FALSE, results='hide', fig.width=11}
