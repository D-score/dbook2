...
gcdg_res <- gcdg_all %>%
  ...
  select(d, Fine_motor, Gross_motor, Expressive, Receptive, Cognitive, Adaptive, a)

ggplot(data = gcdg_res, aes(x=d, y = Fine_motor)) +
  geom_point()+
  ylim(c(-15,15))

ggplot(data = gcdg_res, aes(x=d, y = Gross_motor)) +
  geom_point()+
  ylim(c(-15,15))

ggplot(data = gcdg_res, aes(x=d, y = Expressive)) +
  geom_point()+
  ylim(c(-15,15))

ggplot(data = gcdg_res, aes(x=d, y = Receptive)) +
  geom_point()+
  ylim(c(-15,15))

ggplot(data = gcdg_res, aes(x=d, y = Cognitive)) +
  geom_point()+
  ylim(c(-15,15))
