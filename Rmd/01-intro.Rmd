...
The D-score booklet I [Turning milestones into measurement](https://d-score.org/dbook1) highlights the concepts and tools needed to obtain a quantitative score from a set of developmental milestones.
...
It is straightforward to apply the D-score methodology as explained in [Turning milestones into measurement](https://d-score.org/dbook1) for measurements observed by one instrument. In practice, however, there is a complication. We often need to deal with multiple, partially overlapping tools. For example, our data may contain
