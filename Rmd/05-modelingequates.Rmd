...
It is not clear why `bat` does not fit. Some additional modelling experiments showed that is was extremely difficult to get enough high-quality equate groups that link `bat` to other instruments. Perhaps the scoring system of the Battelle in three categories invokes scoring behavior that is different from PASS/FAIL scoring used by most other instruments. 
