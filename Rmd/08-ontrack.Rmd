...
```{r ontrackref, results = 'hide', fig.keep = 'all',echo=FALSE, message = FALSE, warning = FALSE, fig.width = 7, fig.height = 7, fig.cap = '(ref:ontrackref)'}
...
desc_table <- bind_rows(sex_des, bw_des, edu_des, res_des) %>%
  mutate(prop_1 = round(prop_1 * 100, 1),
         prop_0 = round(prop_0 * 100, 1))
