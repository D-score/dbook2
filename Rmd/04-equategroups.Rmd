...
```{r commonscale,results = 'hide', fig.keep = 'all', echo=FALSE, fig.width = 8, fig.height = 4, fig.cap='(ref:commonscale)', cache = TRUE, warning=FALSE}
...
tiff("fig/fig_4.3.tiff", unit = "in", width = 8, height = 4, res = 300)
grid.arrange(p1, p2, ncol = 2)
dev.off()
```
...
tiff("fig/fig_4.4.tiff", unit = "in", width = 10, height = 10, res = 300)
gridExtra::grid.arrange(ps[["REC6"]], ps[["GM42"]])
dev.off()
```
...
tiff("fig/fig_4.5.tiff", unit = "in", width = 10, height = 10, res = 300)
gridExtra::grid.arrange(psp[["COG24"]], psp[["EXP12"]])
dev.off()
...
tiff("fig/fig_4.6.tiff", unit = "in", width = 10, height = 10, res = 300)
gridExtra::grid.arrange(pdif[["FM31"]], pdif[["EXP26"]])
dev.off()
```
...
tiff("fig/fig_4.7.tiff", unit = "in", width = 10, height = 10, res = 300)
gridExtra::grid.arrange(pdif[["GM44"]], pdif[["EXP23"]])
dev.off()
```
