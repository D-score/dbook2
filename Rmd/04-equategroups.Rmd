...
```{r equateex, echo=FALSE, fig.cap='(ref:equateex)', out.width='400px'}
...
```{r stairpic, echo=FALSE, fig.cap='(ref:stairpic)', out.width='400px'}
...
The Rasch model is the preferred measurement model for child development data. [Booklet I: Chapter 4](https://d-score.org/dbook1/ch-newmodel.html) provides an introduction of the Rasch model geared towards the D-score.
...
[Chapter 6 of booklet I](https://d-score.org/dbook1/ch-evaluation.html) defines the observed response of person $n$ on item $i$ as $x_{ni}$. The accompanying standardized residual $z_{ni}$ is the difference between $x_{ni}$ and the expected response $P_{ni}$, divided by the expected binomial standard deviation,
...
[Booklet I](https://d-score.org/dbook1/sec-dif.html) discusses the role of DIF in the evaluation of fit of items to the Rasch model. This section illustrates similar issues in the context of equate groups.
