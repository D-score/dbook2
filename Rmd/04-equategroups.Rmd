...
```{r equateex, eval=FALSE, fig.cap=, include=FALSE}
...
```{r commonscale, echo=FALSE, fig.width = 8, fig.height = 4, fig.cap='(ref:commonscale)', message=FALSE, warning=FALSE, cache = TRUE}
library(ggplot2)
library(dmetric)
library(gseddata)
library(gridExtra)
...
```{r ploteqfit, results = 'hide', fig.keep = 'all', fig.height = 10, fig.width=10, warning = FALSE, fig.cap = '(ref:ploteqfit)', message = FALSE}
...
```{r ploteqpoor, results = 'hide', fig.keep = 'all', , fig.height = 10, fig.width=10, warning = FALSE, fig.cap = '(ref:ploteqpoor)', message = FALSE, cache = TRUE}
...
```{r plotnoeqdif, results = 'hide', fig.keep = 'all', fig.height = 10, fig.width=10, warning = FALSE, fig.cap = '(ref:plotnoeqdif)', message = FALSE}
...
```{r ploteqdif, results = 'hide', fig.keep = 'all', , fig.height = 10, fig.width=10, warning = FALSE, fig.cap = '(ref:ploteqdif)', message = FALSE}
