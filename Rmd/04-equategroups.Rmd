...
Patterns as in Figure \@ref(fig:equateex) occur if we have multiple forms of the same instrument. Although in theory, there might be sequence effects, the consensus is that the information produced by each item in the equate group does not depend on the form. Such equate groups are of high-quality. We may collect the responses on all items from a high-quality equate group into the same column of the data matrix.

Our methodology generalises the idea of *putting the data into the same column* to multiple - perhaps slightly dissimilar - milestones.
