...
order to verify the fit of the data to the model wel can assess the item fit and
...
ps <- dmetric::plot_p_d_equate(data = dmetric::gcdg_lean , model = dmetric::model_lean)
